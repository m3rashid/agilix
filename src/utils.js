...
export const createBoardForAnons = (userId) => {
	const tasks = [
...

		{
			...
			todos: [],
			description:
				'### Tell me your suggestions, feedback or anything at all!\n[This](http://github.com/m3rashid/agilix) is the link to the Github repo. Drop a 🌟 if you like it. \n**Keep a beginner motivated**.',
		},
		{
			id: '7',
	...
	const columnOrder = {
		id: 'columnOrder',
		order: ['Backlog', 'Waiting', 'In Progress', 'Done'],
	};
