			...
			<div className='bg-gradient-to-br from-white via-indigo-100 to-primary h-screen px-6 py-4 sm:py-20 sm:px-24'>
				...
				<div className='flex flex-col my-2'>
					<div className='flex justify-between'>
						<h1 className='text-xl sm:text-3xl bg-gradient-to-r from-indigo-500 to-primary bg-clip-text text-transparent'>
							Welcome, {name ? name.split(' ')[0] : 'Stranger'}
						</h1>
						<button
							className='px-3 border border-red-800 hover:bg-red-700 hover:text-white text-red-800 px-2 py-1 rounded-sm text-sm sm:text-base'
							onClick={logOut}
						>
							Log out
						</button>
